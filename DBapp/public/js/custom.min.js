...
function init_chart_doughnut1() {
    if ("undefined" != typeof Chart && (console.log("init_chart_doughnut1"), $(".canvasDoughnut1").length)) {
        var data = $('#priorities').text();
        var data = JSON.parse(data);
        var labels = [];
        var values = [];
        for (var ind in data){
          labels.push(data[ind]['priority']);
          values.push(data[ind]['occurence']);
        }
        var a = {
            type: "doughnut",
...
function init_chart_doughnut2() {
    if ("undefined" != typeof Chart && (console.log("init_chart_doughnut2"), $(".canvasDoughnut2").length)) {
        ...
        var values = [];
        for (var ind in data){
          labels.push(data[ind]['src_ips']);
          values.push(data[ind]['count']);
        }
        var a = {
            type: "doughnut",
            tooltipFillColor: "rgba(51, 51, 51, 0.55)",
...
function init_gauge() {
    if ("undefined" != typeof Gauge) {
        ("init_gauge [" + $(".gauge-chart").length + "]"), console.log("init_gauge");
        var a = {
            lines: 12,
            angle: 0,
            lineWidth: .4,
